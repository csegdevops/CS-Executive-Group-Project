...
import { FlaskConical, Users, Building2 } from "lucide-react"
...
const MODULE_META: Record<Module, { label: string; description: string; icon: React.ElementType }> = {
  ...
  recruitment: {
    label: "Recruitment",
    description: "Job postings, candidates, applications and hiring pipelines.",
    icon: Users,
  },
  crm: {
    label: "CRM",
...
export function ModuleToggleList({ configs }: { configs: ModuleConfig[] }) {
  ...
  return (
    <div className="border rounded-lg divide-y text-sm">
      {(["regulatory", "recruitment", "crm"] as Module[]).map((mod) => {
